...
- Runtime factory registers safe default tools: `read_file`, `list_files`, `search_text`, `write_file`, `edit_file`, and `run_test`. `run_shell` is not registered by default.
